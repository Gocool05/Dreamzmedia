      ...
      >
        <SwiperSlide className="flex ">
          ...
          <span className="absolute h-full w-full flex flex-col gap-3 justify-center bg-opacity-45 bg-black items-center text-center">
            ...
            <div class="iconSlider ">
              <a
                href=""
                className="active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#AE8625,-0.5rem_-0.5rem_#AE8625] transition"
              >
                {" "}
        ...
        <SwiperSlide className="flex ">
          ...
          <span className="absolute h-full w-full flex flex-col gap-3 justify-center bg-opacity-45 bg-black items-center text-center">
            ...
            <div class="iconSlider ">
              <a
                href="https://www.facebook.com/people/Movie-mads/100088595811792/"
                target={"_blank"}
                className="active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#ff0015,-0.5rem_-0.5rem_#ff0015] transition"
              >
                {" "}
                <i class="fa fa-facebook "></i>
              </a>
              <a
                href="https://www.instagram.com/moviemadsindia/"
                target={"_blank"}
                className="active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#ff0015,-0.5rem_-0.5rem_#ff0015] transition"
              >
                {" "}
              ...
              <a
                href="https://www.youtube.com/@Moviemadsindia"
                target={"_blank"}
                className="active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#ff0015,-0.5rem_-0.5rem_#ff0015] transition"
              >
                {" "}
              ...
              <a
                href="https://twitter.com/moviemadsindia/"
                target={"_blank"}
                className="active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#ff0015,-0.5rem_-0.5rem_#ff0015] transition"
              >
                {" "}
              ...
              <a
                href="https://www.linkedin.com/in/movie-mads-53233125b/"
                target={"_blank"}
                className="active:translate-x-0.5 active:translate-y-0.5 hover:shadow-[0.5rem_0.5rem_#ff0015,-0.5rem_-0.5rem_#ff0015] transition"
              >
                {" "}
