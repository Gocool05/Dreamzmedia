...
const Gallery = () => {
    ...
    const images = [
        ...
        { src: "../../Images/IMG-20190716-WA0027.jpg", alt: "Dreamzmedia gallery images" },

        { src: "../../Images/FB_IMG_1477915939947 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/FB_IMG_1476119279104 - Copy.jpg", alt: "Dreamzmedia gallery images" },


        { src: "../../Images/IMG-20190126-WA0045 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20190126-WA0037 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20190126-WA0033 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20190111-WA0005 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20181023-WA0017 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20181023-WA0010 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20181023-WA0005 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20180816-WA0011 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20180814-WA0022 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20180814-WA0016 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20180427-WA0014 - Copy.jpg", alt: "Dreamzmedia gallery images" },
        { src: "../../Images/IMG-20180328-WA0015.jpg", alt: "Dreamzmedia gallery images" },
    ];
...
<div class="group overflow-hidden relative after:duration-500 before:duration-500  duration-500 hover:after:duration-500 hover:after:translate-x-24 hover:before:translate-y-12 hover:before:-translate-x-32 hover:duration-500 after:absolute after:w-24 after:h-24  after:rounded-full  after:blur-xl after:bottom-32 after:right-16 after:w-12 after:h-12  before:absolute before:w-20 before:h-20  before:rounded-full  before:blur-xl before:top-20 before:right-16 before:w-12 before:h-12  hover:rotate-12 flex justify-center items-center lg:h-56 lg:w-80  bg-neutral-900 rounded-2xl outline outline-gold -outline-offset-8">
                            <img key={index} className="w-full h-full object-fit cursor-pointer" src={image.src} alt={image.alt} onClick={() => openModal(image.src)} />
                            </div>
                            </div>
                      ))}
                    </div>
                    ...
                    {modalOpen && (
                        <div id="modal" className="fixed top-0 left-0 z-80 w-screen h-screen bg-black/70 flex justify-center items-center">
                            {/* The close button */}
                            <a className="fixed z-90 top-20 right-8 text-white text-5xl font-bold" onClick={closeModal}>
                                ×
                            </a>
