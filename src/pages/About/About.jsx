    ...
    <>
      ...
      <div className="">
        <div class="relative flex flex-col items-center py-14 mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
          ...
          <div class="max-w-lg bg-gray-dark md:max-w-2xl md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
            <div class="flex flex-col p-12 md:px-16">
              <h2 class="text-2xl font-medium uppercase text-gold lg:text-4xl">
                About Dreamzmedia
              </h2>
              <p class="mt-4 text-gray-lite opacity-60">
                With nearly a 17 Years of industry experience, we've partnered
                with top companies and professionals nationwide. Our expertise
                ensures every event is executed with meticulous attention to
                detail. Our mantra, "Flourish your dreams beyond expectations,"
                drives us to consistently expand our satisfied client base.
              </p>
              <div class="mt-8">
